  ...
  class Swap {
    ...
    nulling() {
      ...
      const keyEvent = new KeyboardEvent('keyup', {
        key: 'Control'
      }); // This will disable swapping (helps when releasing the key before finishing the drop/merge) -- which key it actually is sent doesn't matter
...
export { AutoScrollPlugin as AutoScroll, CancelDragPlugin as CancelDrag, MultiDragPlugin as MultiDrag, OnSpill, Sortable, SwapPlugin as Swap };
